    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen">
        ...
        <div class="hidden lg:flex fixed top-0 left-0 h-full w-64 bg-blue-500 p-5 text-white flex-col z-50">
            ...
            @if(auth()->user()->role == 'admin')
                <li class="mb-2">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 p-2 rounded hover:bg-blue-600 text-white">
                ...
                <li class="mb-2">
                    <a href="{{ route('admin.input') }}" class="flex items-center gap-2 p-2 rounded hover:bg-blue-600 text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5">
                        ...
                        <span>Tambah Data Laundry</span>
                    </a>
                </li>
                <li class="mb-2">
                    <a href="{{ route('admin.history') }}" class="flex items-center gap-2 p-2 rounded hover:bg-blue-600 text-white">
